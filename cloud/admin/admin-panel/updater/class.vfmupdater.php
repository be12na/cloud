    ...
    class VFMUpdater
    {
        ...
        public function preparePackage()
        {
            ...
            if (file_exists($expanded)) {
                ...
                $this->scanFolder($expanded.'/'.$this->_slug.'/admin/_content');
        ...
        public function serverCheck()
        {
            $required = array(
                ...
                'writable' => array(
                    'name' => 'cURL',
                    'enabled' => is_writable($this->_main_dir) && is_writable($this->_main_dir.'/admin'),
                    'ok' => 'Main directory writable',
                    'ko' => 'The script has no permissions to write inside the main directores: <br><code class="small">' .$this->_main_dir . '</code><br><code class="small">'.$this->_main_dir.'/admin</code>',
                ),
            );
