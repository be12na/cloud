        ...
        public function updateHtaccess($starting_dir, $direct_links = false)
        {
            ...
            if ($starting_dir !== './') {
                ...
                // if ($direct_links) {
                    ...
                    $insertion[] = "RewriteRule download/(.*)/sh/(.*)/share/(.*) %{ENV:BASE}/admin/vfm-downloader.php?q=$1&sh=$2&share=$3 [L]";
                    $insertion[] = "RewriteRule download/(.*)/h/(.*) %{ENV:BASE}/admin/vfm-downloader.php?q=$1&h=$2 [L]";
                    $insertion[] = "RewriteRule download/zip/(.*)/n/(.*) %{ENV:BASE}/admin/vfm-downloader.php?zip=$1&n=$2 [L]";
                    $insertion[] = "</IfModule>";
                // }
            }
