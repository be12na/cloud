...
if ($gateKeeper->isUserLoggedIn()) {
    $VFMvars['avatar'] = array(
        ...
        // 'image' => $gateKeeper->getAvatar($username, 'admin/'),
    );
}
...
<script src="admin/assets/plyr/plyr.poly.js?v=3.7.2"></script>
    <?php
} ?>
...
if ($debug_mode === true) {
    ...
    ?>
    <script type="text/javascript" src="admin/assets/soundmanager/soundmanager2.js?v=2.97"></script>
    <script type="text/javascript" src="admin/assets/vfm/js/vfm-inlineplayer.js?v=2.97"></script>

    <script type="text/javascript" src="admin/assets/initial/initial.min.js?v=0.2.0"></script>
    <script type="text/javascript" src="admin/assets/cropit/jquery.cropit.min.js?v=0.5.1"></script>
    <script type="text/javascript" src="admin/assets/vfm/js/avatars.js?v=<?php echo VFM_VERSION; ?>"></script>

    <script type="text/javascript" src="admin/assets/bootbox/bootbox.min.js?v=5.5.2"></script>
    <script type="text/javascript" src="admin/assets/datatables/datatables.min.js?v=1.10.16"></script>
    <script type="text/javascript" src="admin/assets/clipboard/clipboard.min.js"></script>

    <script type="text/javascript" src="admin/assets/uploaders/resumable.js?v=1.1.2"></script>
    <script type="text/javascript" src="admin/assets/uploaders/jquery.form.min.js?v=4.3.0"></script>
    <script type="text/javascript" src="admin/assets/vfm/js/uploaders.js?v=<?php echo VFM_VERSION; ?>"></script>

    <script type="text/javascript" src="admin/assets/vfm/js/app.js?v=<?php echo VFM_VERSION; ?>"></script>
    <?php
} else { ?>
