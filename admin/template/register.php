    ...
    */
    if ($setUp->getConfig("registration_enable") == true) { ?>
                    ...
                    <div class="card-body">
                        <form class="needs-validation" id="regform" action="<?php print $location->makeLink(false, null, ""); ?>" novalidate>
                            ...
                            <div id="login_bar" class="form-group">
                                ...
                                <?php
                                $disclaimerfile = 'admin/_content/registration-disclaimer.html';
        ...
        if ($setUp->getConfig('debug_mode')) {
            ?>
        <script type="text/javascript" src="admin/assets/vfm/js/registration.js"></script>
            <?php
        } else { ?>
        <script type="text/javascript" src="admin/js/registration.min.js"></script>
            <?php
        }
    }
}
